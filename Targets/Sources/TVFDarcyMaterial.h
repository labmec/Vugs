#ifndef TVFDARCYMATERIAL_H
#define TVFDARCYMATERIAL_H
...
class TVFDarcyMaterial: public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>,
...
public:
	 ...
	 */
    TVFDarcyMaterial(int id, int dim);

    /**
             copy constructor
     */
    TVFDarcyMaterial(const TVFDarcyMaterial &copy);
    /**
             copy constructor
     */
    TVFDarcyMaterial &operator=(const TVFDarcyMaterial &copy);
    ...
    inline void SetNonLinearContext(bool isNonLinear){
        fNoLinearContext = isNonLinear;
    }
    ...
    void ContributeResidual(const TPZVec<TPZMaterialDataT<STATE>> &datavec, REAL weight, TPZFMatrix<STATE> &ef);
